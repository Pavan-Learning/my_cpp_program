...
int main()
{
    ...
    // here  below size is 8 bytes because it has only one vptr and it is pointing to the vtable of Honda class
    std::cout << "&&&&&&& size of Honda object: " << sizeof(*car) << std::endl;  //
    ...
    // here below size is 16 bytes because it has two vptrs one for Suzuki class and another for Car class and both vptrs are pointing to the vtable of Hyundai class
    std::cout << "&&&&&&& size of Hyundai object: " << sizeof(*hyundai) << std::endl;
    hyundai->stop(); // here it will call the stop() method of Car class because it have inherited car class methods and it is not overridden in Hyundai class so it will call the car class stop method with the help of vptr of Car class which is pointing to the vtable of Hyundai class and it will call the stop() method of Car class because it is not overridden in Hyundai class.
    delete hyundai;
    delete honda;
    delete car;
}   